    ...
    <div class="myPage__nftMenu">
      <div class="myPage__tabMenu tabMenu page__margin--mid">
        ...
        <div class="myPage__tabMenu--bar tabMenu__bar">
          <div 
          class="myPage__tabMenu--active tabMenu__bar--active tabMenu__bar--active3"
...
<script>
  ...
  export default {
    ...
    data: () => ({
      // 프로필 기본 정보
      id                :0,                                        // 초기 아이디 값
      userImgUrl        :require('assets/./img/test/test-card9.png'), // 유저 이미지
      userName          :'단발꼬마',                                 // 닉네임
      comment           :'즐길 것이 많은 나이 한량한 백수 입니다.',         // 소개
