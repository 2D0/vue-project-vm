<template>
  <div class="auction listPage">
      <article class="page__overHidden">
        <Hooper 
          :settings="hooperSetting" 
          class="slide__slider listPage__slider"
        >
          <Slide
            v-for="item in slide"
            :key="item.id" 
            class="listPage__slide--inner"
          >
            <NuxtLink to="detail" class="listPage__slide">
              <div class="listPage__banner--back page__img">
              ...
              <div class="listPage__left">
                ...
                <div class="listPage__num">
                  ...
                  <div class="listPage__price">
                    <span class="listPage__price--tit listPage__num--tit">현재가</span>
      ...
      <article class="listPage__cont listPage__cont--back auction__cont">
        <div class="container__inner--max">
          ...
          <ul class="itemList__cards">
            ...
            >
              <div @click.stop="$router.push('/auction/detail')" class="card">
                <div class="card__inner">
                    ...
                    <div class="card__user page">
                      ...
                      <p class="card__userName">
                        <span @click.stop="$router.push('/myPage/userItem/home')">{{itemCard.userName}}</span>
                      </p>
                    </div>
  ...
  export default {
    ...
    data: () => ({
      ...
      slide      : [
        {
          name      :'앵두같은 입술',                                   // 아이템 이름
          userName  :'키라키라',                                      // 판매자 이름
          price     :'60,142',                                    // 아이템 가격
          time      :'03D : 13 : 47 : 30',                        // 아이템 남은 시간
          imgUrl    :require('assets/./img/test/test-card9.png'),           // 아이템 이미지
          userImgUrl:require('assets/./img/test/test-card10.png'),           // 판매 유저 이미지
          state     :'진행중',                                      // 판매 상태
        ...
        },
        {
          ...
          userImgUrl:require('assets/./img/test/test-card4.png'),           // 판매 유저 이미지
          state     :'진행중',                                      // 판매 상태
          likeCount :'1,829',                                     // 좋아요 수
        },
        {
          ...
          userImgUrl:require('assets/./img/test/test-card9.png'),           // 판매 유저 이미지
          state     :'진행중',                                      // 판매 상태
          likeCount :'1,829',                                     // 좋아요 수
        },
        {
